...
/*
 ...
 If you are trying to read the SJSU Viewfinder code, it doesn't start here. This is just a platform-dependent main file to initiate the irrlicht code.
 
 Start at SJSUViewfinder.cpp.
...
SJSUViewfinder* viewfinder;


cv::Matx33f getCamIntrinsic() {
    return cv::Matx33f(525.32967417905104,                  0, 138.14918723668063,
                                        0, 518.81670403727776, 239.54536460624888,
                                        0,                  0,                  1);
}
...
#endif
{
    ...
    viewfinder = new SJSUViewfinder(device);
...
- (void)applicationDidFinishLaunching:(UIApplication*)application 
{
    ...
    [((ViewController*)window.rootViewController).videoCamera start];
